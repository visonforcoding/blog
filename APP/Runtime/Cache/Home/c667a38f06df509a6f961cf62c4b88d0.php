    ...
    <div id="center" class="container">
        ...
        <div class="unit">
            ...
            <div class="unit_contnet">
                <?php if(is_array($book)): foreach($book as $key=>$v): ?><div class="book_unit">
                            <div class="book_img">
                                <a  href="__APP__/Home/Book/book/id/<?php echo ($v["id"]); ?>.html" data-trigger="hover" title="<?php echo ($v["name"]); ?>" 
                                    class="book"  data-content="<?php echo ($v["admire"]); ?>">
                                    <img src="<?php echo ($v["pic"]); ?>"  alt="<?php echo ($v["name"]); ?>"/>
                                </a>
                            </div>
                            <div class="book_info">
                                <p class="book_bar"><a class="thumbsup"><i class="icon-thumbs-up"></i> 赞(<?php echo ($v["praise"]); ?>)</a>
                                    <a class="download"><i class="icon-download-alt"></i> 下载(<?php echo ($v["down"]); ?>)</a></p>
                            </div>
                            <div class="book_name">
                                <h5> <a><?php echo ($v["shortname"]); ?></a></h5>
                            </div>
